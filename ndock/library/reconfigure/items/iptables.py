...
ChainData.bind_collection(
    'rules', selector=lambda x: x.name == 'append', item_class=RuleData)
...
OptionData.bind_collection(
    'arguments', selector=lambda x: x.name == 'argument', item_class=ArgumentData)
