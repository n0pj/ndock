...
from ..items.util import onezero_getter, onezero_setter
...
CSFData.bind_property('TESTING', 'testing',
                      getter=onezero_getter, setter=onezero_setter)
CSFData.bind_property(
    'IPV6', 'ipv6', getter=onezero_getter, setter=onezero_setter)
