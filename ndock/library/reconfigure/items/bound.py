...
class BoundData (object):
    ...
    def template(self, **kwargs):
        ...
        :returns: a :class:`..nodes.Node` tree that will be used as a template for new BoundData instance
        """
        return None
    ...
    def bind_property(cls, node_property, data_property, default=None,
        ...
        """
        Binds the value of a child :class:`..node.PropertyNode` to a property
