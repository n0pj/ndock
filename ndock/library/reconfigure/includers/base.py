class BaseIncluder (object):  # pragma: no cover
    ...
    def compose(self, origin, tree):
        """
        Should locate the include nodes in the Node tree, replace them with :class:`..nodes.IncludeNode`, parse the specified include files and append them to tree, with correct node ``origin`` attributes
        """
